      ...
      <AccordionDetails sx={{ padding: 0 }}>
        <TableContainer component={Paper} sx={{ border: "none" }}>
          <Table>
            ...
            <TableBody>
              <TableRow>
                <TableCell>Seyahatin İptali</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Bagaj Kaybı</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Aktarma Uçuşunun Kaçırılması</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Gıda Zehirlenmesi</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Seyahatin Gecikmesi</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Overbooking Nedeniyle Gecikme</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Erken Dönüş Masrafları</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Tedavi Nedeniyle Konaklama</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Refakatçinin Konaklaması</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Bagajın Bulunması Ve Ulaştırılması</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Bagaj Gecikmesi</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Vize Reddi</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Mücbir Sebeple Uçuşun Kaçırılması</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Hukuki Danışma</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Acil Mesajların İletilmesi</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>İlaç Gönderilmesi</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Kefalet İçin Avans Ödeme </TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Yurt Dışında Nakit Avans</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
              ...
              <TableRow>
                <TableCell>Sağlık Nakli Ve Cenaze Nakli</TableCell>
                {offers.map((offer) => (
                  <TableCell
                    key={offer.name}
                    align="center"
